            ...
            else
            {
                ...
                foreach (KeyValuePair<string, Dictionary<uint, AsnType>> kvp in result)
                {
                    ...
                    EntPhysicalTable table = new EntPhysicalTable()
                    {
                        ...
                        entPhysicalDescr = rowData.ElementAt(0),
                        entPhysicalVendorType = rowData.ElementAt(1),
                        entPhysicalContainedIn = rowData.ElementAt(2),
                        entPhysicalClass = rowData.ElementAt(3),
                        entPhysicalParentRelPos = rowData.ElementAt(4),
                        entPhysicalName = rowData.ElementAt(5),
                        entPhysicalHardwareRev = rowData.ElementAt(6),
                        entPhysicalFirmwareRev = rowData.ElementAt(7),
                        entPhysicalSoftwareRev = rowData.ElementAt(8),
                        entPhysicalSerialNum = rowData.ElementAt(9),
                        entPhysicalMfgName = rowData.ElementAt(10),
                        entPhysicalModelName = rowData.ElementAt(11),
                        entPhysicalAlias = rowData.ElementAt(12),
                        entPhysicalAssetID = rowData.ElementAt(13),
                        entPhysicalIsFRU = rowData.ElementAt(14),
                        entPhysicalMfgDate = rowData.ElementAt(15),
                        entPhysicalUris = rowData.ElementAt(16),
